...
INSERT INTO menu(item, size1, size2, size3, size4)
VALUES	
		-- Fried Rice
		...
		('Fried Dumplings', 5.25, 0, 0, 0),
		('Steam Dumplings', 5.25, 0, 0, 0),
		('Cheese Wontons (8)', 4.5, 0, 0, 0),
		('Fried Pork Wontons (8)', 4.5, 0, 0, 0),
		('Fried Scallops (8)', 3.99, 0, 0, 0),
		('Fried Nuggets (8)', 3.99, 0, 0, 0),
		('Fried Onions (8)', 2.75, 0, 0, 0),
		('Apple Sticks (8)', 2.75, 0, 0, 0),
		('Teriyaki Chicken (5)', 4.69, 0, 0, 0),
		('Teriyaki Beef (5)', 4.99, 0, 0, 0),
		('Fried Shrimp', 6.99, 0, 0, 0),

		-- Side Orders
		('White Rice', 2.5, 3, 0, 0),
		('Sweet & Sour Sauce', 1, 0, 0, 0),
		('Coral Sauce', 1, 0, 0, 0),
